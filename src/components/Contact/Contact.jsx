          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-gray-800 py-8 px-6">
            <div className="col-span-2 space-y-3">
              <h1 className="text-4xl sm:text-5xl font-bold text-white">
                Let's collaborate on your upcoming QuickWheels venture
              </h1>
              <p className="text-gray-400">
                When latest car will launch and you want to be informed,
                give me your contact Information so that we can inform you About
                the latest car.{" "}
              </p>
            </div>
